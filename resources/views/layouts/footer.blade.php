                    ...
                    <div class="row">
                        ...
                        <div>
                            ...
                            <form action="{{ route('subscribers.store') }}" method="post" class="flex mt-4 items-center"> 
                                @csrf
                                <div class="flex right-0 top-0 w-full mt-3">
                                    <input 
                                        type="email" name="email" placeholder="Ex. fulano@email.com"
                                        class="w-full pr-16 input input-primary input-bordered text-sm rounded-lg rounded-r-none focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 p-2.5 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500" 
                                    >
                                    <button class="right-0 top-0 btn btn-primary inline-flex items-center rounded-l-none pl-0 ml-0 py-2.5 px-3 text-sm font-medium text-white bg-indigo-500 rounded-lg border-2 border-indigo-500 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">
                                        Inscrever
                                    </button>
                                </div>
                            </form>
