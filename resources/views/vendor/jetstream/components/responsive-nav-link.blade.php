...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-green-300 text-base font-medium text-indigo-300 bg-indigo-50 focus:outline-none focus:text-indigo-800 focus:bg-indigo-900 focus:border-indigo-300 transition duration-150 ease-in-out'
